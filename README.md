...
**ulackroad workerd edge** is part of the **BlackRoad OS** ecosystem — a sovereign, distributed operating system built on edge computing, local AI, and mesh networking by **BlackRoad OS, Inc.**
...
> BlackRoad Workerd Edge — self-hosted Cloudflare Workers runtime on Raspberry Pi and DigitalOcean
